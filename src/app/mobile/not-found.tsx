...
// /mobile/not-found
//
// Custom 404 for the mobile app. Keeps the user inside /mobile — the button
// goes to /mobile/inicio (or /mobile/login if not authenticated), NEVER to
// the main site root.
//
// Next.js App Router: a not-found.tsx in a route segment handles 404s for
// that segment and its children.
// ─────────────────────────────────────────────────────────────────────────────
...
export default function MobileNotFound() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-white px-6">
      ...
      <button
        onClick={() => router.replace('/mobile/inicio')}
