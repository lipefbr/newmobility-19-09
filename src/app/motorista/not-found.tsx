...
// /motorista/not-found
//
// Custom 404 for the motorista app. Keeps the user inside /motorista — the
// button goes to /motorista/inicio (or /motorista/login if not authenticated),
// NEVER to the main site root.
// ─────────────────────────────────────────────────────────────────────────────

const PRIMARY = '#155EEF'

export default function MotoristaNotFound() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-white px-6">
      ...
      <p className="text-sm text-gray-500 text-center max-w-xs leading-relaxed mb-8">
        ...
        app do Motorista NewMobility.
      </p>

      <button
        onClick={() => router.replace('/motorista/inicio')}
