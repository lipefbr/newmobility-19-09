...
// MobileComingSoon
//
// Reusable placeholder screen for /mobile/* routes that haven't been built yet
// (carteira, pedidos, procurar, and all 8 category pages). Keeps the user
// inside /mobile — the back button goes to /mobile/inicio, never outside.
// ─────────────────────────────────────────────────────────────────────────────
    ...
    <MobileAppShell>
      ...
      <div className="flex flex-col items-center justify-center px-6 py-20 text-center">
        ...
        <p className="text-sm text-gray-500 max-w-xs leading-relaxed">
          {description ||
            `Estamos preparando esta área para você. A funcionalidade "${title}" estará disponível em uma próxima atualização do app NewMobility.`}
        </p>
        <div
